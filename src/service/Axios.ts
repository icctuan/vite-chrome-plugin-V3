...
export class VAxios {
	...
	get<T = TransformedResultType>(config: AxiosRequestConfig, options?: RequestOptions): Promise<T> {
	...
	put<T = TransformedResultType>(config: AxiosRequestConfig, options?: RequestOptions): Promise<T> {
